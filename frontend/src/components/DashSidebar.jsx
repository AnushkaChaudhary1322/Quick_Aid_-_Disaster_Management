          ...
          <Sidebar.Items>
            <Sidebar.ItemGroup className="flex flex-col ">
              ...
              <Link to="/alerts" onClick={toggleSidebar}>
                <Sidebar.Item icon={HiBellAlert}>Alerts</Sidebar.Item>
              </Link>
              ...
              <Link to="/volunteers" onClick={toggleSidebar}>
                <Sidebar.Item icon={MdOutlineVolunteerActivism}>
                Volunteer
                </Sidebar.Item>
              </Link>

              <Link to="/tasks" onClick={toggleSidebar}>
                <Sidebar.Item icon={FaTasks}>
                Tasks
                </Sidebar.Item>
              </Link>
