    ...
    if (currentUser) {
      ...
      return (
        <div className="fixed md:relative">
          <button
            ...
            className="text-blue-800 relative focus:outline-none"
            aria-haspopup="true"
      ...
      if (location.pathname === "/signup") {
        return (
          <Link
            to="/login"
            className="bg-blue-400 text-blue-800 py-2 px-4 rounded-lg hover:bg-blue-300 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            Sign In
          </Link>
        );
    ...
    <>
      <header className="text-gray-800 p-4 flex flex-wrap justify-between items-center sticky top-0 bg-white z-10 shadow-md">
        ...
        <nav className="hidden md:flex md:items-center md:w-auto w-full">
          <Link
            to="/"
            className="block lg:inline-block hover:text-gray-400 font-bold px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            Home
          </Link>
          <Link
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          {renderSignupButton()}
          <button
            className="md:hidden text-2xl focus:outline-none focus:ring-2 focus:ring-blue-500"
