    ...
    <>
      <div className="flex flex-col gap-6 p-20 px-4 max-w-6xl mx-auto">
        <h1 className="text-blue-700 font-bold text-3xl lg:text-6xl">
          Discover Quick-Aid for your next{" "}
          <span className="text-blue-500">critical</span>
          <br />
          disaster management solution
        </h1>
        <div className="text-gray-600 text-xs sm:text-sm">
          Quick-Aid, your reliable partner in disaster management, where every
      ...
      <footer className="mt-10 bg-gray-200 flex flex-col md:flex-row items-center md:justify-between">
        ...
        <div className="p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-center">
          <div className="flex flex-col text-center sm:text-left">
            <a href="/privacy" className="text-gray-600 hover:text-gray-900 mb-1">
              Privacy Policy
            </a>
