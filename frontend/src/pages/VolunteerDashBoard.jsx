...
import { FiCheckCircle, FiList, FiAward, FiAlertCircle, FiPhone } from "react-icons/fi";
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="dashboard-card bg-blue-600 p-6 rounded-lg shadow-md flex items-center justify-between">
        ...
        <div className="dashboard-card bg-teal-600 p-6 rounded-lg shadow-md flex items-center justify-between">
        ...
        <div className="dashboard-card bg-yellow-600 p-6 rounded-lg shadow-md flex items-center justify-between">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:bg-gray-100 transition-colors">
        ...
        <ProgressBar now={(completedTasks / (totalTasks || 1)) * 100} />
      </div>
    </div>
  );
};
